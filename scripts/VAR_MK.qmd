...
draws_beta <- net_1_fit$draws("Beta") %>% as_draws_matrix()
draws_sigma <- net_1_fit$draws("Sigma") %>% as_draws_matrix()
 
net_1_data_1_loo <- loo_gVAR(stan_fit = net_1_fit, data = data_1)
net_1_data_2_loo <- loo_gVAR(stan_fit = net_1_fit, data = data_2)
net_2_data_2_loo <- loo_gVAR(stan_fit = net_2_fit, data = data_2)
net_2_data_1_loo <- loo_gVAR(stan_fit = net_2_fit, data = data_1)
```
