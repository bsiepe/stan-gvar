...
compare_mat <-
  function(mat1,
           mat2,
           bootstrap_samples = 0,
           H1_prior_scale = 0.5, # normal SD
           H0_prior_scale = 0.1, # "normal" = SD, "uniform" = range / 2
           H0_distribution = "uniform", # c("normal", "uniform", "posterior_uncertainty")
           plot = TRUE,
           plot_xlim = NULL,
           plot_ylim = NA
           ) {
    ...
    cat(paste0(
      "\n Posterior samples below Null ROPE range upper bound: ",
    ...
    cat(paste0(
      "\n Prior samples below Null ROPE range upper bound: ",
    ...
    # if there is an overlap for posterior and null but not for prior and null omit BF  
      ...
      dens_overlap_coef <- bayestestR::overlap(diff_post, diff_null)
      
      return(dens_overlap_coef)
