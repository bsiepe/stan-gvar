...
net_1_data_1_loo <- loo_gVAR(stan_fit = net_1a_fit, data = data_1a, n_cores = cores)
net_1_data_2_loo <- loo_gVAR(stan_fit = net_1a_fit, data = data_1b, n_cores = cores)
net_2_data_2_loo <- loo_gVAR(stan_fit = net_1b_fit, data = data_1b, n_cores = cores)
net_2_data_1_loo <- loo_gVAR(stan_fit = net_1b_fit, data = data_1a, n_cores = cores)
```
